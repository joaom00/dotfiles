...
M.config = function()
  O.lang.python = {
    ...
    lsp = {path = DATA_PATH .. '/lspinstall/python/node_modules/.bin/pyright-langserver'}
  }
end
...
M.lint = function()
  require('lint').linters_by_ft = {python = O.lang.python.linters}
end

M.lsp = function()
  require('lspconfig').pyright.setup {
    cmd = {O.lang.python.lsp.path, '--stdio'},
