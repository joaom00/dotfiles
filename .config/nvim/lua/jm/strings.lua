...
M.separator = function()
  return { component = constants.ALIGN, length = 0, priority = 0 }
end
---@type fun(): StringComponent
M.end_marker = function()
  return { component = constants.END, length = 0, priority = 0 }
end
...
local function sum_lengths(list)
  return jm.fold(function(acc, item)
